...
import static com.xrosstools.xunit.editor.actions.GenerateHelperAction.capitalize;
import static com.xrosstools.xunit.editor.actions.GenerateHelperAction.getValue;
import static com.xrosstools.xunit.editor.actions.GenerateHelperAction.replace;
import static com.xrosstools.xunit.editor.actions.GenerateHelperAction.toClassName;
...
public class GenerateTestAction extends WorkbenchPartAction {
    ...
    public GenerateTestAction(IWorkbenchPart part, UnitNodeDiagram diagram) {
    	super(part);
    ...
    public void run() {
        ...
        new CodeDisplayer("Generated test", classBuf.toString()).open();
    }
}